...
Recalcar que esta versión reducida del dataset estará balanceada por clases para que el rendimiento de los modelos no disminuya. Esta versión reducida (`genius_song_lyrics`), con la que se ha trabajado, así que los datasets `genius_song_lyrics_tokenized` y `genius_artists` generados por el notebook [1_1-EDA](1_1-EDA.ipynb) y utilizados en el notebook [1_2-EDA](1_2-EDAipynb) se pueden encontrar en este [directorio](https://drive.google.com/drive/folders/1fMaua4canhWuvx8bIGY3fcX1LSS6l-sj?usp=sharing)
...
Para instalar las librerias necesarias para los notebooks [1_1-EDA](1_1-EDAipynb) y [1_1-EDA](1_2-EDAipynb), crea un entorno usando el fichero [requirements_EDA.txt](requirements_EDA.txt) .
